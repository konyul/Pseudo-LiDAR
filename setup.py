...
class PostInstallation(install):
    ...
    def run(self):
        ...
        subprocess.call([
            sys.executable, '-m', 'pip', 'install', 'kornia==0.5.2',
            '--no-dependencies'
        ])
...
if __name__ == '__main__':
    ...
    setup(
        ...
        install_requires=[
            'numpy', 'torch>=1.1', 'spconv', 'numba', 'tensorboardX',
            'easydict', 'pyyaml'
        ],
        ...
        ext_modules=[
            make_cuda_ext(name='iou3d_nms_cuda',
            ...
            make_cuda_ext(name='roiaware_pool3d_cuda',
                          module='pcdet.ops.roiaware_pool3d',
                          sources=[
                              'src/roiaware_pool3d.cpp',
                              'src/roiaware_pool3d_kernel.cu',
                          ]),
            make_cuda_ext_mmdet3d(name='voxel_layer',
            ...
            make_cuda_ext(name='roipoint_pool3d_cuda',
